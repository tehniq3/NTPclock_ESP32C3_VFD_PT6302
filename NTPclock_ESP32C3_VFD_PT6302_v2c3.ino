...
Ecran 5  "14:32:56 Senin  " (sau "14:32 nori: 75% ")
Ecran 6: "14:32:56 761mmHg"
Ecran 7: "14:32 NV 9.3km/h" (sau "14:32 NV 15km/h")
Ecran 8: "14:32 uv<1  |___" (sau "14:32 uv= 1 |___"
Ecran 9: "14:32 aq=40 ||__"
 */
...
void displayScreen(struct tm* t) {
  ...
  switch(displayMode) {
    ...
    case 1: // "14:32  Duminica " (sau "14:32:56  Luni  ")
      { 
    ...
    case 4: // "14:32:56  Senin    " (sau "14:32  Ninsoare  ")
      { 
        ...
        //display = timeShort + " " + cStr + "% nori "; // Păstrează partea cu norii
          display = timeShort + " " + "nori: " + cStr + "% "; // Păstrează partea cu norii
        } else {
    ...
    case 7: // "14:32 UV 5 [|O  ]"
      { 
       ...
       if (uvIndex < 1.) uvNum = "<1 ";
        else uvNum = "=" + (uvInt < 10) ? " " + String(uvInt) : String(uvInt); //String((int)round(uvIndex));         
