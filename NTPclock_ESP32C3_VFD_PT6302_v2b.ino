...
Ecran 3 (3s) : "14:32  Senin    "   (sau "Cer cu 75% nori ")
Ecran 4 (3s) : "t:25.5^C um:45% "
...
void updateWeather() {
  ...
  // AM MODIFICAT AICI: surface_pressure -> pressure_msl
  ...
  switch(displayMode) {
    ...
    case 1: 
      { 
        ...
        if (day.length() == 7) display = getTimeString(t) + " " + day;
    ...
    case 2: 
      { 
        ...
        if (wText == "Cer cu nori") {
          ...
          display = "Cer cu " + cStr + "% nori";
        } else {
          display = getTimeStringShort(t) + " " + wText;
        }
      }
      break;
